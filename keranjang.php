    ...
    <div class="container">
        <div class="card">
            <div class="card-header" style="background-color: #222831;">
                <h1 style="color: #ffffff;">Daftar Produk Dalam Keranjang</h1>
            </div>
            <div class="card-body">
                <?php 
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?=$value['harga']?></td>
                            <td><?=$value['qty']?></td>
                            <td><a href="deletecart.php?id=<?= $key ?>" class="btn btn-danger" 
                                onclick="return confirm('Apakah anda yakin menghapus produk ini dari keranjang?')">Hapus</a></td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
                <a href="checkout.php" type="button" class="btn btn-secondary"  onclick="return confirm('Yakin untuk transaksi?')">Check Out</a>
                <?php } ?>
            </div>
        </div>
    </div>
